...
import com.sbms.client.AddressClient;
...
public class CustomerServiceImpl implements CustomerService {
	...
	@Override
	public CustomerResponse getCusotmerwithAddress(int id) {
		
		CustomerResponse customerResponse=new CustomerResponse();
		CustomerDto customerDto=fetchCustomer(id);
		
		//AddressDto addressDto=restTemplate.getForObject("http://localhost:9092/address/fetchAddress/"+CustomerDto.getCustId(), AddressDto.class);
		AddressDto addressDto=client.getAddressDetails(customerDto.getCustId());
